...
import '../screens/client/catalog_screen.dart' as catalog_screen;
...
class AppRouter {
  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case home:
        return MaterialPageRoute(
          builder: (_) => const DashboardScreen(), // O la pantalla principal que uses
          settings: settings,
        );

      case catalog:
        return MaterialPageRoute(
          builder: (_) => const catalog_screen.CatalogScreen(),
          settings: settings,
        );
      ...
      default:
        return MaterialPageRoute(
          builder: (_) => const LoginScreen(), // Pantalla por defecto
          settings: settings,
        );
    }
  }
