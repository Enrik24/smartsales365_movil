...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _login() async {
    ...
    try {
      ...
      if (response.success && response.data != null) {
        ...
        final message = '¡Bienvenido, ${user.nombre}!';
        ...
        if (mounted) {
          // En tu sistema actual, aún no hay roles, así que usamos “cliente”
          await AppRouter.navigateBasedOnUserType(
            context,
            'cliente', // tipo de usuario predeterminado
            user.nombre,
          );
        }
      } else {
  ...
  Future<void> _loginWithGoogle() async {
    ...
    try {
      // ⚠️ Por ahora solo prueba local (mock token)
